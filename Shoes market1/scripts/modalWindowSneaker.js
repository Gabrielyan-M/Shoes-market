...
cardsArray.forEach(cardObject => {
    ...
    document.querySelector('.info-sneakers-block').innerHTML += `
    ...
    //                         <img src="media/sneakers/${cardObject.image}.png" alt="sneaker">
    //                     </div>
    ...
    //                                 <div class="sizes-block__container">
    //                                     <div class="size-button" data-sneaker-size="38">38</div>
    //                                     <div class="size-button" data-sneaker-size="39">39</div>
    //                                     <div class="size-button" data-sneaker-size="40">40</div>
    //                                     <div class="size-button" data-sneaker-size="41">41</div>
    //                                     <div class="size-button" data-sneaker-size="42">42</div>
    //                                     <div class="size-button" data-sneaker-size="43">43</div>
    //                                     <div class="size-button" data-sneaker-size="44">44</div>
    //                                     <div class="size-button" data-sneaker-size="45">45</div>
    //                                 </div>
    //                             </div>
    ...
    //                                     <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    //                                         <path d="M27.5 6C24.3753 6 22.0109 7.81897 20 9.71973C18.0838 7.70271 15.6247 6 12.5 6C8.09936 6 5 9.75318 5 13.8458C5 16.0414 5.90657 17.6232 6.89936 19.1083L18.5553 32.9699C19.8641 34.3434 20.1106 34.3434 21.4194 32.9699L33.1015 19.1083C34.2687 17.6232 35 16.0414 35 13.8458C35 9.75323 31.9006 6 27.5 6ZM31.25 18.7234L20 32.0381L8.75 18.6685C7.40471 16.8133 6.875 15.5616 6.875 13.8458C6.875 10.6487 9.17657 7.77059 12.5 7.7436C15.2338 7.72128 18.3322 10.4906 20 12.5783C21.6238 10.5632 24.7662 7.7436 27.5 7.7436C30.7353 7.7436 33.125 10.6487 33.125 13.8458C33.125 15.5616 32.7059 16.9062 31.25 18.7234Z" fill="black" stroke="black"/>
    //                                     </svg>
    //                                 </button>
    //                             </div>
    //                         </div>
                        ...
                        <div class="info-model-sneaker-block">
                            ...
                            <div class="add-to-bag-block">
                                <div class="sizes-block">
                                    ...
                                    <div class="sizes-block__container" data-sizes-block="${cardObject.idProduct}">
...
document.querySelectorAll('.image-block').forEach(image => {
    image.addEventListener('pointerenter', () => {
        ...
        document.querySelector('.viewed-image').attributes.style = null
        document.querySelector('.viewed-image').setAttribute('style', image.getAttribute('style'))
...
const modalInfoSneakerBlocks = document.querySelectorAll('.info-sneakers-block')


sizeButtons.forEach(sizeButton => {
      sizeButton.addEventListener('click', (e) => {
            console.log(sizeButton.getAttribute('data-sneaker-size'));
